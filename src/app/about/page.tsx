    ...
    return (
      ...
      <div className="text-center mt-8">
        ...
        <p className="text-lg text-gray-700 mt-2">
          At Tasty Bites, our mission is to inspire home cooks to experiment, create, and enjoy the process of cooking. We aim to make every meal an opportunity to connect with loved ones and savor life's flavors.
        </p>
      </div>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <p className="text-lg text-gray-700 mt-4">
            I'm Safa, the founder and food enthusiast behind Tasty Bites. I've been passionate about cooking for over 5 years, and I'm here to share my love for food with you through simple, delicious recipes!
          </p>
        </div>
      </div>
